...
class CandidateApiTest {
    ...
    void create(){
        ...
        assertEquals(candidate.jobTitle(), dto.job_title());
    }

    @Test
    void update(){
        String id = UUID.randomUUID().toString();
        UpadateCandidate dto = Instancio.create(UpadateCandidate.class);
        ...
        assertEquals(api.dto.out.fromDomain(candidate), response);
    }
